...
class Length {
	...
	public function __construct($registry) {
		...
		$length_class_query = $this->db->from('length_class mc')
			->join('length_class_description mcd', 'mc.length_class_id = mcd.length_class_id')
			->where(array('mcd.language_id' => (int)$this->config->get('config_language_id')))
			->get();
