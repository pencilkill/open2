...
<script type="text/javascript" src="view/javascript/jquery/php.js"></script>
...
<div id="header">
  <div class="div1">
    <div class="div2"><img src="view/image/logo.gif" height="26" title="<?php echo $heading_title; ?>" onclick="location = '<?php echo $home; ?>'" /></div>
    <?php if ($logged) { ?>
