	      ...
	      <div id="language<?php echo $language['language_id']; ?>">
	        <table class="form">
	          ...
	          <tr>
	            ...
	            <td>
	            	<textarea rows="" cols="" name="news_description[<?php echo $language['language_id']; ?>][description]" class="ckeditor"><?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['description'] : ''; ?></textarea>
	          ...
	          <tr>
	          	...
	          	<td><input type="text" name="news_description[<?php echo $language['language_id']; ?>][keyword]" size="120" value="<?php echo isset($news_description[$language['language_id']]) ? $news_description[$language['language_id']]['keyword'] : ''; ?>" /></td>
	          </tr>
	        </table>
	      </div>
		  <?php } ?>
