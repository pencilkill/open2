		...
		if ($fraud_info) {
			...
			*/
			...
			if ($response) {
				...
				$this->db->insert('order_fraud', array(
					...
					'ip_accuracy_radius' => (int)$ip_accuracy_radius,
					'ip_net_speed_cell' => $ip_net_speed_cell,
					'ip_metro_code' => (int)$ip_metro_code,
					'ip_area_code' => (int)$ip_area_code,
					...
					'queries_remaining' => (int)$queries_remaining,
